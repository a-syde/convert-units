...
tests['tsp/s to l/s'] = function () {
  var expected = 1.75
  var actual = convert(355).from('tsp/s').to('l/s')
...
tests['in3/s to l/s'] = function () {
  ...
  var actual = convert(1).from('in3/s').to('l/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['in3/s to fl-oz/s'] = function () {
  ...
  var actual = convert(1).from('in3/s').to('fl-oz/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['m3/s to yd3/s'] = function () {
  ...
  var actual = convert(1).from('m3/s').to('yd3/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['ft3/s to cm3/s'] = function () {
  ...
  var actual = convert(1).from('ft3/s').to('cm3/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['pnt/s to ml/s'] = function () {
  var expected = 2366
  var actual = convert(5).from('pnt/s').to('ml/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['ml/s to gal/s'] = function () {
  var expected = 2.609
  var actual = convert(9876).from('ml/s').to('gal/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['gal/s to l/s'] = function () {
  ...
  var actual = convert(1).from('gal/s').to('l/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['kl/s to kl/min'] = function () {
  var expected = 60
  var actual = convert(1).from('kl/s').to('kl/min')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['l/s to kl/h'] = function () {
  var expected = 3.6
  var actual = convert(1).from('l/s').to('kl/h')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['kl/min to l/h'] = function () {
  var expected = 60000
  var actual = convert(1).from('kl/min').to('l/h')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['l/s to m3/h'] = function () {
  var expected = 3.6
  var actual = convert(1).from('l/s').to('m3/h')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['m3/s to kl/h'] = function () {
  var expected = 3600
  var actual = convert(1).from('m3/s').to('kl/h')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['fl-oz/s to m3/min'] = function () {
  ...
  var actual = convert(1).from('fl-oz/s').to('m3/min')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['ft3/min to l/s'] = function () {
  ...
  var actual = convert(1).from('ft3/min').to('l/s')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['pnt/min to kl/h'] = function () {
  ...
  var actual = convert(1).from('pnt/min').to('kl/h')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['yd3/h to m3/min'] = function () {
  ...
  var actual = convert(1).from('yd3/h').to('m3/min')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
