...
tests['l possibilities'] = function () {
  ...
  var expected = [ 'mm3', 'cm3', 'ml', 'cl', 'dl', 'l', 'kl', 'm3', 'km3', 'krm', 'tsk', 'msk', 'kkp', 'glas', 'kanna', 'tsp', 'Tbs', 'in3', 'fl-oz', 'cup', 'pnt', 'qt', 'gal', 'ft3', 'yd3' ]
  assert.deepEqual(actual.sort(), expected.sort())
}

tests['kg possibilities'] = function () {
  var actual = convert().from('kg').possibilities()
  var expected = [ 'mcg', 'mg', 'g', 'kg', 'mt', 'oz', 'lb', 't' ]
  assert.deepEqual(actual.sort(), expected.sort())
}

tests['m possibilities'] = function () {
  var actual = convert().from('m').possibilities()
  var expected = [ 'mm', 'cm', 'm', 'km', 'in', 'yd', 'ft-us', 'ft', 'fathom', 'mi', 'nMi' ]
  assert.deepEqual(actual.sort(), expected.sort())
}
...
tests['volume flow rate possibilities'] = function () {
  ...
  var expected = [ 'mm3/s', 'cm3/s', 'ml/s', 'cl/s', 'dl/s', 'l/s', 'l/min', 'l/h', 'kl/s', 'kl/min', 'kl/h', 'm3/s', 'm3/min', 'm3/h', 'km3/s', 'tsp/s', 'Tbs/s', 'in3/s', 'in3/min', 'in3/h', 'fl-oz/s', 'fl-oz/min', 'fl-oz/h', 'cup/s', 'pnt/s', 'pnt/min', 'pnt/h', 'qt/s', 'gal/s', 'gal/min', 'gal/h', 'ft3/s', 'ft3/min', 'ft3/h', 'yd3/s', 'yd3/min', 'yd3/h' ]
  assert.deepEqual(actual.sort(), expected.sort())
}
