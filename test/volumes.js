...
tests['tsp to l'] = function () {
  var expected = 1.75
  var actual = convert(355).from('tsp').to('l')
...
tests['in3 to l'] = function () {
  ...
  var actual = convert(1).from('in3').to('l')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['in3 to fl-oz'] = function () {
  ...
  var actual = convert(1).from('in3').to('fl-oz')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['m3 to yd3'] = function () {
  ...
  var actual = convert(1).from('m3').to('yd3')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['ft3 to cm3'] = function () {
  ...
  var actual = convert(1).from('ft3').to('cm3')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['pnt to ml'] = function () {
  var expected = 2366
  var actual = convert(5).from('pnt').to('ml')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['ml to gal'] = function () {
  var expected = 2.609
  var actual = convert(9876).from('ml').to('gal')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
...
tests['gal to l'] = function () {
  var expected = 37.85
  var actual = convert(10).from('gal').to('l')
  assert.ok(percentError(expected, actual) < ACCURACY
    , 'Expected: ' + expected + ', Actual: ' + actual)
}
